...
def get_model(weights='imagenet'):
    ...
    predictins = Dense(input=class_limit, activation="softmax")
    ...
    model = Sequential()
    model.add(Dense(base_model.input.shape(1), activation='relu'))
